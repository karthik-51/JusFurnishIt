...
//           axios.get(`http://localhost:8083/api/customer/cart/${id}`)
//             .then(resp => {
//               const cartItems = resp.data;
//               if (cartItems.length > 0) {
//                 const latestProductId = cartItems[cartItems.length - 1].productId;
//                 setSelectedProductId(latestProductId);

//                 // Fetch product details
//                 axios.get(`http://localhost:8082/api/designer/products/${latestProductId}`)
...
//       const response = await axios.post('http://localhost:8085/api/bookings', bookingPayload);
...
//       <h2 className="text-xl font-bold mb-4">Book Your Design</h2>

//       {productDetails && (
//         <div className="mb-6 p-4 border bg-gray-50 rounded">
//           <h3 className="text-lg font-semibold mb-2">Product Details</h3>
//           <p><strong>Category:</strong> {productDetails.category}</p>
//           <p><strong>Theme:</strong> {productDetails.theme}</p>
//           <p><strong>Short Bio:</strong> {productDetails.shortBio}</p>
...
//       const bookingResponse = await axios.post('http://localhost:8085/api/bookings', bookingPayload);
      
//       if (bookingResponse.status !== 200 && bookingResponse.status !== 201) {
//         setMessage('Booking creation failed. Please try again.');
//         return;
//       }

//       // Initialize Razorpay payment
//       const options = {
//         key: 'rzp_test_VVihXmzDUx9h5s', // Replace with your Razorpay test key
//         amount: productDetails.price * 100, // Amount in paise
//         currency: 'INR',
//         name: 'Design Product Booking',
//         description: `Booking for ${productDetails.theme}`,
...
//           contact: '9999999999' // Dummy contact for test
//         },
//         notes: {
...
//             <Typography><strong>Theme:</strong> {productDetails.theme}</Typography>
//             <Typography><strong>Short Bio:</strong> {productDetails.shortBio}</Typography>
//             <Typography><strong>Description:</strong> {productDetails.description}</Typography>
//             <Typography sx={{ mb: 1 }}><strong>Price:</strong> ₹{productDetails.price}</Typography>
//             {productDetails.image && (
//               <CardMedia
//                 component="img"
//                 image={`data:image/jpeg;base64,${productDetails.image}`}
//                 alt="Product"
//                 sx={{
//                   mt: 2,
//                   borderRadius: 2,
...
//     try {
//       // 1. Create a booking for each cart item (NO /bulk endpoint)
