...
const DesignsTab = ({ userId }) => {
  ...
  const fetchDesigns = () => {
    axios
      .get(`http://localhost:8082/api/maindesigner/${userId}/designs`, {
  ...
  const handleDelete = (designId) => {
    axios
      .delete(`http://localhost:8082/api/maindesigner/${userId}/designs/${designId}`, {
        withCredentials: true,
      })
      .then(() => {
  ...
  const handleFormSubmit = () => {
    ...
    const endpoint =
      formMode === "add"
        ? `http://localhost:8082/api/maindesigner/${userId}/designs`
        : `http://localhost:8082/api/maindesigner/${userId}/designs/${selectedDesign.id}`;
