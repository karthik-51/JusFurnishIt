...
const ProductTab = ({ userId }) => {
  ...
  const fetchProducts = () => {
    axios
      .get(`http://localhost:8082/api/maindesigner/${userId}/products`, {
  ...
  const handleDelete = (productId) => {
    axios
      .delete(`http://localhost:8082/api/maindesigner/${userId}/products/${productId}`, {
        withCredentials: true,
      })
      .then(() => {
  ...
  const handleFormSubmit = () => {
    ...
    const endpoint =
      formMode === "add"
        ? `http://localhost:8082/api/maindesigner/${userId}/products`
        : `http://localhost:8082/api/maindesigner/${userId}/products/${selectedProduct.id}`;
